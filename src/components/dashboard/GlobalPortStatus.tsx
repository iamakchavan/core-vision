...
const portData = [
  { id: "240", name: "Port of Los Angeles", status: "normal", lat: 33.7, lng: -118.2, x: "18%", y: "45%" },
  { id: "160", name: "Port of Shanghai", status: "congested", lat: 31.2, lng: 121.5, x: "75%", y: "35%" },
  { id: "180", name: "Port of Singapore", status: "normal", lat: 1.3, lng: 103.8, x: "78%", y: "65%" },
  { id: "420", name: "Port of Rotterdam", status: "reroute", lat: 51.9, lng: 4.1, x: "48%", y: "25%" }
];
